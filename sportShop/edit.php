...
$id=$_GET['id'];
$user=$dbHelper->getCustomerById($id);
...
if(isset($_POST['update']))
{
    ...
    $dbHelper->updateCustomer($name,$email,$address,$password,$id);
        ...
        <div class="breadcrumb-banner d-flex flex-wrap align-items-center">
            <div class="col-first">
                ...
                <nav class="d-flex align-items-center justify-content-start">
                    ...
                    <a href="checkout.html">Edit User Page</a>
                </nav>
            </div>
        </div>
    </div>
...
<div class="section-half">
    ...
    <form method="post">
        ...
        <p class="text-center"> <button type="submit" class="btn btn-primary" name="update" >Edit</button></p>
    </form>
    </div>
</div>
