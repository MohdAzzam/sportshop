$(document).ready(function () {
    ...
    $("#search-field").on('input', function () {
        ...
        var name = $("#search-field").val();
        var id = $("#search-field").attr("data-id");
        const data = {
            name: name,
            id: id
        };
        ...
        if (document.getElementById("price-range")) {
            ...
            noUiSlider.create(nonLinearSlider, {
                ...
                range: {
                    ...
                    // until 400 is reached. From there, step by 1.
                    'min': [0],
                    'max': [400]
                }
            });
            ...
            nonLinearSlider.noUiSlider.on('update', function (values, handle, unencoded, isTap, positions) {
                ...
                const minValue = parseInt($("#lower-value").text());
                const maxValue = parseInt($("#upper-value").text());

                if (maxValue !== "Nan") {
                    var data;
                    var flag = false;
                    var id = $("#search-field").attr("data-id");
                    if (minValue !== 0 && maxValue !== 400) {
                        flag = true;
                        data = {
                            min_value: minValue,
                            max_value: maxValue,
